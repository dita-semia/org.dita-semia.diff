...
public class GetHashFromStringDef extends ExtensionFunctionDefinition {
	
	public static final String LOCAL_NAME	= "getHashFromString"; 
	...
	public ExtensionFunctionCall makeCallExpression() {
		return new GetHashFromStringCall();
	}
